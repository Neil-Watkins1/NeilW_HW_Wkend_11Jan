...
class TestPetShop < Minitest::Test
  ...
  # in the test above does my method require a count instruction?
  ...
  #Need to check the method for the above is actually adding the
  # new pet to the customer array
